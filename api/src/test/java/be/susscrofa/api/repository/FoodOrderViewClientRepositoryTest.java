...
public class FoodOrderViewClientRepositoryTest extends AbstractRepositoryTest {

    @Autowired
    private FoodOrderClientViewRepository foodOrderClientViewRepository;
    ...
    void testFindAllByNameAndSurname() {
        ...
        var foodsOrders = foodOrderClientViewRepository.getAllByOrderDay(data.day1);
        assertThat(foodsOrders.size()).isEqualTo(2);
        assertThat(foodsOrders)
                .usingRecursiveFieldByFieldElementComparator()
                .containsExactlyInAnyOrder(
                ClientWithFoodOrderView.builder()
                        .id(client1.getId())
                        ...
                        .foodsOrders(
                                List.of(ClientWithFoodOrderView.FoodOrderGroupedByClient.builder()
                                        .id(new ClientWithFoodOrderView.FoodOrderGroupedByClient.
                                        ...
                                        .build(),
                                ClientWithFoodOrderView.FoodOrderGroupedByClient.builder()
                                        .id(new ClientWithFoodOrderView.FoodOrderGroupedByClient.
